export const translations = {
  ...
  sv: {
    ...
    // cancel: 'Avbryt',
    zonePlaceholder: 't.ex. Z5 plan 3 Lgh 3001-3004',
    taskNameLabel: 'Uppgiftsnamn',
    taskNamePlaceholder: 't.ex. Städning av plats',
    componentPlaceholder: 'Grundkonstruktioner, Komposit, .....',
    addButton: 'Lägg till +',
    projectsCol: 'Projekt',
    ...
    jobTitlePlaceholder: 'Välj en jobbtitel',
    roleLabel: 'Roll',
    jobTitles: {
      siteManager: 'Platschef',
      foreman: 'Arbetsledare',
      projectManager: 'Projektchef',
      designManager: 'Projekteringsledare',
      purchaser: 'Inköpare',
